...
export const CustomSelect = ({ 
  ...
  useEffect(() => {
    ...
    const updateScrollbarThumb = () => {
      const scrollRatio = optionsContainer.scrollTop / (optionsContainer.scrollHeight - optionsContainer.clientHeight);
      const thumbPosition = scrollRatio * (scrollbar.clientHeight - thumb.clientHeight);
    ...
    const onMouseMove = (e) => {
      ...
      const scrollAmount = scrollRatio * (optionsContainer.scrollHeight - optionsContainer.clientHeight);
