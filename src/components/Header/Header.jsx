	...
	return (
		<header className={css.wrapper}>
			<div className={css.logoOverlay}>
				<button type="button" className={css.menuBtn} onClick={toggleSidebar}>
					<svg className={css.icon}>
						<use href={`${sprite}#icon-burguer`} />
					</svg>
				</button>

				<Link to="/dashboard" className={css.logoLink}>
					<picture>
						<source srcSet="/logo.png 1x, /logo@2x.png 2x" />
						<img src="/logo.png" alt="logo icon" className={css.logo} />
					</picture>
				</Link>
